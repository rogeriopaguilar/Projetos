...
public class UpperCaseMaxLengthDocument extends PlainDocument {
    	 
    	 BaseJTextBox baseJTextBox = null;
    	 
    	 public UpperCaseMaxLengthDocument(BaseJTextBox baseJTextBox){
