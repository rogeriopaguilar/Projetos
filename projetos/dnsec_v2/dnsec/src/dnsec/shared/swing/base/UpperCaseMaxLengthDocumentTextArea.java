...
public class UpperCaseMaxLengthDocumentTextArea extends PlainDocument {
    	 
    	 BaseJTextArea baseJTextArea= null;
    	 
    	 public UpperCaseMaxLengthDocumentTextArea(BaseJTextArea baseJTextArea){
    		 this.baseJTextArea = baseJTextArea;
    	 }	
    	 
    	 public void insertString(int offs, String str, AttributeSet a) 
             throws BadLocationException {
 
             int tamanhoMaximo = baseJTextArea.getTamanhoMaximo();
             ...
             if(this.baseJTextArea.exibirMaiuscula){
